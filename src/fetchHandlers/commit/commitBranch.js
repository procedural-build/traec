...
export const getAllBranches = ({ trackerId, include_edges = false, include_nodes = false }) => {
  let queryParams = [include_edges ? `include_edges=True` : "", include_nodes ? `include_nodes=True` : ""].join("&");
  ...
  const fetchParams = {
    ...
    queryParams: { include_edges: false, include_nodes: false }
  };
