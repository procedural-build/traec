...
export default class Fetch {
    ...
    constructor(apiId, method, params, overrides = {}) {
        ...
        this.preDispatchHook = (action) => {return action}
        this.preUpdateHook = (args) => {return args}
    ...
    dispatch() {
        if (this.hasFetched()) { return null }
    ...
    dispatchFromProps(props, fetchedUrls, stateSet, forceFetch=false) {
        ...
        if (!this.hasRequiredParams(newProps)) { return null }
